...
export default class Game extends Component{
    ...
    componentDidMount(){
        ...
        if(this.props.mode === "new"){
            ...
            let url = "http://192.168.0.14:8080/minesweeper/v1/"+w+"/"+h+"/"+m;
            fetch(url)
            .then(res => res.json())
            .then(json => {
    ...
    handleClick = (e) => {
        ...
        let url = "http://192.168.0.14:8080/minesweeper/v1/"+this.state.id+"/"+id;
    ...
    saveGame = e => {
        let url = "http://192.168.0.14:8080/minesweeper/v1/"+this.state.id+"/"+this.props.session.name;
